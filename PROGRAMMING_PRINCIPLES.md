...
У проєкті використовується повторне використання методів замість дублювання коду. Наприклад, метод `AddFile()` використовується для додавання файлів у різних місцях програми.
